...
export default function imagePublicationAccount({ route, navigation }) {
  ...
  return (
    <View style={{flex:1, justifyContent: "center", alignItems: 'center'}}>
          <ImageBackground source={image} style={{ flex: 1, width: deviceWidth, height: deviceHeight, borderRadius: 25 }} />
